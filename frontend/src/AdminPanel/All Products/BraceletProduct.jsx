...
import { useAddBaraceletDetailsMutation } from '../../features/bracelets';
...
function BraceletProduct() {
    ...
    const [addBraceletDetails, { error }] = useAddBaraceletDetailsMutation();
    ...
    const handleSubmit = async (values, { resetForm }) => {
        ...
        try {
            await addBraceletDetails(newProduct);
            resetForm();
            setVariants([]); 
            setUploadedImages([]);
                ...
                <div className="row">
                    <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
                        {({ errors, touched, values }) => (
                            <Form className="form">
                                <h1 className="h3 mb-3 fw-normal text-center text-uppercase heading">Add Product <strong>Bracelet</strong></h1>
