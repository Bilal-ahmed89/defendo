...
import { useAddPendantDetailsMutation } from '../../features/pendants';


function PendantProduct() {

    const [addPendantDetails, { error }] = useAddPendantDetailsMutation();
    ...
    const handleSubmit = async (values, { resetForm }) => {
        ...
        try {
            await addPendantDetails(newProduct);
            resetForm();
            setVariants([]); 
            setUploadedImages([]);
