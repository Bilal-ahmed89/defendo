...
import { useDeleteRingDetailsMutation } from '../../features/rings';
...
const RingCategory = () => {
    ...
    const { data } = useGetRingDetailsQuery();
    const [deleteRingDetailsMutation] = useDeleteRingDetailsMutation();
    ...
    const handleDelete = async (id) => {
        try {
            console.log(id);
            await deleteRingDetailsMutation(id);
    ...
    return (
        <div className='p-2 container'>
            <h2 className='text-center mt-4'>Ring Category</h2>
