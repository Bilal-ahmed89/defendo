...
import { useDeleteChainDetailsMutation, useGetChainDetailsQuery } from '../../features/chains';
import ChainProduct from '../All Products/ChainProduct'


const ChainCategory = () => {

    const [Products, setProducts] = useState([]);
    const { data } = useGetChainDetailsQuery();
    const [ deleteChainDetailsMutation ] = useDeleteChainDetailsMutation();
    ...
    const handleDelete = async (id) => {
        try {
            ...
            await deleteChainDetailsMutation(id);
    ...
    return (
        <div className='p-2 container'>
            <h2 className='text-center mt-4'>Chain Category</h2>
