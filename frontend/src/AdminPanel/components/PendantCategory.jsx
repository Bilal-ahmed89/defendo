...
import { useDeletePendantDetailsMutation, useGetPendantDetailsQuery } from '../../features/pendants';
import PendantProduct from '../All Products/PendantProduct';



const PendantCategory = () => {

    const [Products, setProducts] = useState([]);
    const { data } = useGetPendantDetailsQuery();
    const [ deletePendantDetailsMutation ] = useDeletePendantDetailsMutation();
    ...
    const handleDelete = async (id) => {
        try {
            ...
            await deletePendantDetailsMutation(id);
    ...
    return (
        <div className='p-2 container'>
            <h2 className='text-center mt-4'>Pendant Category</h2>
...
export default PendantCategory;
